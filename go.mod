module github.com/simplecloudapp/simplecloud-gate

go 1.26.0

require (
	buf.build/gen/go/simplecloud/controller/protocolbuffers/go v1.36.11-20260307111646-50c9870526a2.1
